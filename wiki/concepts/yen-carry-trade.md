...
created: 2026-04-17
updated: 2026-04-18
sources: ["raw/20240417_B_20210092_852.pdf", "raw/Japan_FX_Capitulation_of_JPY_carry_Only_the_beginning_of_the_end-Japan_FX.pdf", "raw/24809_Significant position unwinding, and what is USDJPYs next move_nomura.pdf", "raw/240829_엔 캐리 트레이드가 실제로 무엇인지에 대해 말하다_신현송박사_원본.pdf"]
confidence: high
---
...
| 엔화 투기적 포지션(CME) | 포지션 누적·청산 규모 추정 (단기 투기적 포지션만 반영) |
| 일본 소재 외국계 은행 본점 송금액 | 글로벌 자금 흐름 대체지표 |
| **BIS 엔화 외화 차입 잔액** | 온밸런스시트 캐리 규모: 약 40조엔($2,700억), 이 중 역내외 사무소간 14조엔 (2023년 기준) |
| **엔/기타통화 FX 스왑 잔액** | 오프밸런스시트 캐리 규모: 약 $14조 — 온밸런스시트의 52배. 실질 캐리의 주된 경로 |
| 달러-엔 FX 스왑 베이시스 | 캐리 방향 탐지: 베이시스가 거의 변동 없으면 달러 쟁탈이 아닌 엔화 반제 동인 시사 |
